...
USE Retail
GO
CREATE TABLE Retail.dbo.Employee 
    (EmpID INT NOT NULL , 
...
GO
INSERT INTO Retail.dbo.Employee 
...
CREATE TABLE Retail.dbo.EmployeeDetails(
	[EmpID] [int] NULL,
...
ALTER TABLE Retail.dbo.EmployeeDetails  WITH CHECK ADD  CONSTRAINT [FK_EmployeeDetails_Employee] 
    FOREIGN KEY([EmpID])
REFERENCES [dbo].[Employee] ([EmpID])
GO

ALTER TABLE Retail.dbo.EmployeeDetails CHECK CONSTRAINT [FK_EmployeeDetails_Employee]
GO

INSERT INTO Retail.dbo.EmployeeDetails 
...
SELECT * FROM Retail.dbo.Employee;
SELECT * FROM Retail.dbo.EmployeeDetails;