...
# crobles - 202003 - Added new validation for SQL Server upgrades
#==============================================================================
...
# crobles - 202003
# Added new function to deploy DBA monitoring job
dba_mon () {

    # Starting sp_WhoIsActive init
    echo -e "\nDBA - Activity logging job objects" | tee -a $log
...
# crobles - 202003
# Added new validation for SQL Server upgrades
if [ $upgrade -eq 0 ]
then
    ...
    then
        ...
        # Wait for SQL Server upgrade
        echo -e "\nSQL Server will be upgraded .... \n\n" | tee -a $log
        echo -e "Waiting $wait_sql for SQL Server to start\n\n" | tee -a $log
        sleep $wait_sql
fi